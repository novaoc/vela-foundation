...
# Keep the default production topology genuinely single-database: these
# adapter tables are part of the primary migration stream. Deployments that
# provide an explicit *_DATABASE_URL may still point an adapter at its named
# database and load the upstream schema file there.
